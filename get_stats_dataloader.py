...
class RopeTrajectoryDataset(Dataset):
    ...
    def __init__(self, data_dir, network_dir, network, cfg_dir='../cfg', transform=None, features='priya',  dataset_fraction=1, save_im=False, postprocess=False):
